...
Keep your tone warm and welcoming — many parents are new to the league.`
    ...
    coach: {
      ...
      resources: {
        newCoachesPrimer: { description: "JYO New Coaches Primer — essential info for coaches, gym access, resources", url: "https://drive.google.com/file/d/1iuRMlnJNyHmn9p7AQayvYr4-eTaovI0S/view?usp=sharing", name: "JYO New Coaches Primer" },
...
Keep your tone collegial and practical — coaches are busy volunteers.`
    ...
    manager: {
      ...
      resources: {
        managerHandbook: { description: "Manager Handbook — comprehensive guide for team managers", url: "https://docs.google.com/document/d/1sish6XTWJNNUP0VZeEHsQtl5sLhQskEnb9Q3sDQi1iE/edit?usp=sharing", name: "Manager Handbook" },
        gameDayGuide: { description: "NYBA Game Day Guide — game day setup, responsibilities, and procedures", url: "https://docs.google.com/document/d/11b4gSPZExmVcoQr78kdi7JfqhSvQTmK1Q8-idn-1DEE/edit?usp=sharing", name: "NYBA Game Day Guide" },
